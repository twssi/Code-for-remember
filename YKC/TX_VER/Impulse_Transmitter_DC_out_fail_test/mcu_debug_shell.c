...
#if 0
static void debug_shell_command_11(DEBUG_SHELL_COMMAND_FUNCTION_ARG);
static void debug_shell_command_12(DEBUG_SHELL_COMMAND_FUNCTION_ARG);
#endif
...
static debug_shell_command_t _debug_shell_command_collection[]=
{
	...
	{"io" 		 , debug_shell_command_09 },
	{"redundant" , debug_shell_command_10 }
...
#if 0
void debug_shell_command_11(DEBUG_SHELL_COMMAND_FUNCTION_ARG)
{
//	in_module_show();
}

void debug_shell_command_12(DEBUG_SHELL_COMMAND_FUNCTION_ARG)
{
//	out_module_1_3_show();
}
#endif
...
void debug_shell (void)
{
	...
	rx_size = com_recv_buffer(COM3, rx, sizeof(rx));
	if (rx_size > 0u)
	{
		count = rx_size;
		for (i=0u; i<count; i++)
