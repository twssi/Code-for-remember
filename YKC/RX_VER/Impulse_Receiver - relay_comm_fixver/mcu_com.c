...
static USART_TypeDef* _MCU_USART[COM_MAX_PORT] = { USART1, USART2, USART3, UART4 };

#else

static USART_TypeDef* _MCU_USART[COM_MAX_PORT] = { CX_NULL_POINTER, CX_NULL_POINTER, CX_NULL_POINTER, CX_NULL_POINTER};
