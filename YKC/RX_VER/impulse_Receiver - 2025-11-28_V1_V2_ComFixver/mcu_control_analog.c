...
#define SAMPLING_COUNT_RELAY_VOLTAGE	3u
...
void get_input_data_relay_voltage(cx_bool_t active_relay_measure, cx_uint_t relay_count_value)
{
    ...
    if(active_relay_measure == CX_TRUE)
    {
        ...
        if(_count_V1_average>=SAMPLING_COUNT_RELAY_VOLTAGE)
		{
			...
			_measured_relay_voltage_V1 = (cx_uint_t)((_average_V1_value * 17u) / 90u); //34V 기준
			//_measured_relay_voltage_V1 = (cx_uint_t)((_average_V1_value * 19) / 90); //35V 기준
			//_measured_relay_voltage_V1 = (cx_uint_t)((_average_V1_value/11)*10);
			//if(_average_V1_value < 2400)
 			//if(_measured_relay_voltage_V1>= 1730 && _measured_relay_voltage_V1 < 1950)_measured_relay_voltage_V1 = _measured_relay_voltage_V1*2/100;
			 /*
        ...
        if(_count_V2_average>=SAMPLING_COUNT_RELAY_VOLTAGE)
		{
			...
			_measured_relay_voltage_V2 = (cx_uint_t)((_average_V2_value * 9) / 32 - 381);
			//_measured_relay_voltage_V2 = (cx_uint_t)((_average_V2_value * 53) / 320);
